...
struct domain
{
    domid_t          domain_id;		/* domain id  */

	dgid_t			group_id;		/* domain group id*/

	struct  list_head	member;     /* domain group -- replace struct group ptr */

    shared_info_t   *shared_info;     /* shared data area */

    spinlock_t       domain_lock;	/* lock for preemption */

	spinlock_t		 *group_big_lock;		/* group lock */
...
struct	domain_group
{
	...
	struct	list_head	member_list; 	/* group member*/

	spinlock_t	group_big_lock;
...
/******************************************************************
*		Domain setup information struct							  *
******************************************************************/
