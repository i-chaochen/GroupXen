...
from xen.xend.XendConstants import DOM_STATE_HALTED, NULL_GROUP_ID, NULL_GROUP_UUID
...
XENAPI_CFG_TO_LEGACY_CFG = {
    'uuid': 'uuid',
    'dgid': 'dgid',     # domain group id
    'dguuid': 'dguuid',  # domain group uuid
    'VCPUs_max': 'vcpus',
    'cpus': 'cpus',
    'name_label': 'name',
...
XENAPI_CFG_TYPES = {
    'uuid': str,
    'dgid': int,	# domain group id
    'dguuid': str,	# domain group uuid
    'name_label': str,
...
LEGACY_CFG_TYPES = {
    ...
    'dgid':	     int,	# domain group id
    'dguuid':	     str,	# domain group uuid
    'grp_name':	     str,	# domain group name
    'name':          str,
    'vcpus':         int,
    'vcpu_avail':    long,
    'memory':        int,
...
LEGACY_XENSTORE_VM_PARAMS = [
    'uuid',
    'dgid',	# domain group id 
    'dguuid',	# domain group uuid
    'name',
    'vcpus',
    'vcpu_avail',
    'memory',
...
class XendConfig(dict):
    ...
    def _defaults(self):
        defaults = {
            ...
            'vtpm_refs': [],
            'other_config': {},
            'dgid': NULL_GROUP_ID,		# domain group id
            'dguuid': NULL_GROUP_UUID,		# domain group uuid
            'platform': {},
            'target': 0,
            'superpages': 0,
            'description': '',
...
#########################################################################
	...
	self['dgid'] = dominfo['dgid']		# domain group
...
#########################################################################
        for legacy in LEGACY_UNSUPPORTED_BY_XENAPI_CFG:
            if legacy in ('domid', 'uuid', 'dgid', 'dguuid', 'cpus'): # skip these
                continue
